...

{
  ...
  programs.zed-editor = {
    ...
    # User settings - using raw JSON file for full control
    # Note: The Zed home-manager module doesn't support all settings yet,
    # so we use home.file for complete configuration
  };
